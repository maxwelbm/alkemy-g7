...
// @Tags Buyer
// @Produce json
// @Success 200 {object} responses.BuyerResponseSwagger
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to list Buyers"
// @Router /buyers [get]
...
// @Success 200 {object} responses.BuyerResponseSwagger{data=model.Buyer}
// @Failure 400 {object} responses.ErrorResponseSwagger "Invalid ID"
// @Failure 404 {object} responses.ErrorResponseSwagger "Buyer Not Found"
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to search for buyer"
...
// @Failure 400 {object} responses.ErrorResponseSwagger "Invalid ID"
// @Failure 404 {object} responses.ErrorResponseSwagger "Buyer not found"
// @Failure 409 {object} responses.ErrorResponseSwagger "Buyer cannot be deleted due to existing dependencies"
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to delete buyer"
...
// @Success 201 {object} responses.BuyerResponseSwagger{data=model.Buyer}
// @Failure 400 {object} responses.ErrorResponseSwagger "Unprocessable Entity"
// @Failure 409 {object} responses.ErrorResponseSwagger "Card number already exists"
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to create buyer"
// @Router /buyers [post]
...
// @Param id path int true "Buyer ID"
// @Param buyer body model.Buyer true "Buyer information"
// @Success 200 {object} responses.BuyerResponseSwagger{data=model.Buyer} "Buyer successfully updated"
// @Example 200 { "data": {"id": 1, "name": "Updated Buyer", "card_number": "1234-5678-9012-3456"} }
// @Failure 422 {object} responses.ErrorResponseSwagger "Unprocessable Entity"
// @Failure 404 {object} responses.ErrorResponseSwagger "Buyer not found"
// @Failure 409 {object} responses.ErrorResponseSwagger "Card number already exists"
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to update buyer"
...
// @Success 200 {object} responses.BuyerResponseSwagger{data=model.BuyerPurchaseOrder}
// @Failure 400 {object} responses.ErrorResponseSwagger "Invalid ID"
// @Failure 500 {object} responses.ErrorResponseSwagger "Unable to count buyer purchase orders"
