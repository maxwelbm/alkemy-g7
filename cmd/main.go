...
func main() {
	...
	productHandler, employeeHd, sellersHandler, buyerHandler, warehousesHandler, sectionHandler, inboundHandler := dependencies.LoadDependencies(db.Connection)

	rt := initRoutes(productHandler, employeeHd, sellersHandler, buyerHandler, sectionHandler, warehousesHandler, inboundHandler)
...
func initRoutes(productHandler *handler.ProductHandler,
	...
	warehouseHandler *handler.WarehouseHandler, inboundHandler *handler.InboundOrderHandler) *chi.Mux {
